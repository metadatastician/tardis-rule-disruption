...
project := "tardis-rule-disruption"
OWNER := "metadatastician"
REPO := "tardis-rule-disruption"
version := "0.1.0"
...
info:
    @echo "Project: tardis_rule_disruption"
...
build *args:
    @echo "Building tardis_rule_disruption (debug)..."
...
build-release *args:
    @echo "Building tardis_rule_disruption (release)..."
...
install: build-release
    @echo "Installing tardis_rule_disruption..."
...
cookbook:
    ...
    echo "= tardis_rule_disruption Justfile Cookbook" > "$OUTPUT"
...
man:
    #!/usr/bin/env bash
    mkdir -p docs/man
    cat > docs/man/tardis_rule_disruption.1 << EOF
    .TH tardis_rule_disruption 1 "$(date +%Y-%m-%d)" "{{version}}" "tardis_rule_disruption Manual"
    .SH NAME
    tardis_rule_disruption \- RSR-compliant project
    .SH SYNOPSIS
    .B just
    [recipe] [args...]
    .SH DESCRIPTION
    ...
    EOF
    echo "Generated: docs/man/tardis_rule_disruption.1"
...
doctor:
    @echo "Running diagnostics for tardis-rule-disruption..."
...
tour:
    @echo "=== tardis-rule-disruption Tour ==="
    @echo ""
...
help-me:
    @echo "=== tardis-rule-disruption Help ==="
    @echo "Platform: $(uname -s) $(uname -m)"
    @echo "Shell: $SHELL"
    @echo ""
    @echo "To report an issue:"
    @echo "  https://github.com/metadatastician/tardis-rule-disruption/issues/new"
    @echo ""
