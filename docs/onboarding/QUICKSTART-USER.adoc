...
// Replace tardis-rule-disruption, Rsr Template Repo — See README.adoc for details., just run, Rsr Template Repo started successfully. with actuals
= tardis-rule-disruption — Quick Start for Users
:toc:
:toclevels: 2

== What is tardis-rule-disruption?
...
[source,bash]
----
just install --portable --prefix=./tardis-rule-disruption-portable
----
