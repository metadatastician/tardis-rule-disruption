...
Developers working *on* `TARDIS`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:metadatastician/TARDIS.git
cd TARDIS
...
* Bugs in `TARDIS`: file at `metadatastician/TARDIS/issues`.
