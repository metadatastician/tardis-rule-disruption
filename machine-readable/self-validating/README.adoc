...
cp machine-readable/contractiles/k9/examples/project-metadata.k9.ncl config/metadata.k9.ncl

# Yard: Validated configuration
cp machine-readable/contractiles/k9/examples/ci-config.k9.ncl .github/ci.k9.ncl

# Hunt: Full automation
cp machine-readable/contractiles/k9/examples/setup-repo.k9.ncl scripts/setup.k9.ncl
----
